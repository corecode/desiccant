...
initial$M <- calcMs(initial$Wavg, initial$T)

N <- 100
state <- c(Wavg=rep(initial$Wavg, N), Ts=rep(initial$Ts, N), Te=rep(initial$T), Me=rep(initial$M))
